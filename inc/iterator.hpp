...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/06/07 11:53:18 by hwinston          #+#    #+#             */
/*   Updated: 2021/06/19 09:06:53 by hwinston         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*
** Custom implementation of the iterator header
*/
...
namespace ft
{
	...
	class iterator
	{
		...
		public:
			...
			explicit iterator(pointer it)
			{
				_it = it;
			}
	
			template <class Iter>
			iterator(const iterator<iterator_category, Iter>& it)
			{
				_it = it.base();
			}
		...
		/* --- non-member function overloads (iterator) -------------- */
		
		template <class Iterator, class Category>
		bool operator==(const iterator<Category, Iterator>& lhs,
			const iterator<Category, Iterator>& rhs)
		{
		...
		template <class Iterator, class Category>
		iterator<Category, Iterator> operator+ (
			typename iterator<Category, Iterator>::difference_type n,
			const iterator<Category, Iterator>& it)
		{
			return it + n;
		}

		template <class Iterator, class Category>
		typename iterator<Category, Iterator>::difference_type operator- (
			const iterator<Category, Iterator>& lhs,
			const iterator<Category, Iterator>& rhs)
		{
