...
/*   Updated: 2022/01/19 17:16:44 by hwinston         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main()
{
    ...
    std::cout << std::endl;
    std::cout << "--------------------------------------------------------" << std::endl;
    std::cout << "---------------------- hard Julio ----------------------" << std::endl; 
    std::cout << std::endl;
    
    {
        bool(*fn_pt)(int,int) = fncomp_map;
		ft::map<char,VALUE_TYPE_1,bool(*)(int,int)> sixth (fn_pt);

		sixth.insert(ft::make_pair('a', 10));
		sixth.insert(ft::make_pair('b', 20));
